...
public class Test09_A2_6 {
    ...
    @Test
     public void test() {
        ...
        Card card2 = new Card(Card.ACE,Card.Suit.DIAMONDS); //Hand value is 9,Ace
             
        myHand.hit(card1);
        myHand.hit(card2);
        
        Card upCard = new Card(6,Card.Suit.HEARTS);         //Dealer's upcard is 6
